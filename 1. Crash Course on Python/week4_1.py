...
# of the input string is: numeric house number, followed by the street name which may contain 
# numbers, but never by themselves, and could be several words long. 
